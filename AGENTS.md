...
- Planning year defaults to `PLAN_YEAR` (`2027`). In the planner, users can switch **2026 | 2027** (navbar / mobile). Prefer `?year=2026` deep links; preference is stored in `holiday-planner-plan-year`. Marketing SEO stays on 2027; landing links to `/app/?year=2026` for remaining 2026 planning.
